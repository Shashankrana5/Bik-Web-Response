        ...
        if (order[1] === "reverse") {
          setTickets(
            JSON.parse(
              JSON.stringify(
                tickets.sort((a: Ticket, b: Ticket) =>
                  a.category.category > b.category.category ? 1 : b.category.category > a.category.category ? -1 : 0,
                ),
              ),
            ),
          );
          ...
          setTickets(
            JSON.parse(
              JSON.stringify(
                tickets.sort((a: Ticket, b: Ticket) =>
                  a.category.category > b.category.category ? 0 : b.category.category > a.category.category ? -1 : 0,
                ),
              ),
            ).reverse(),
          );
            ...
            {tickets &&
              tickets.map(
                (
                  ...
                  return (
                    <tr key={ticketNumber} className="cursor-pointer border-y border-blue-gray-100 bg-blue-gray-50/50 p-4 transition-colors hover:bg-gray-100">
