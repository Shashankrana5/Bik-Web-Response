...
const DisplayGroupChatMessage_1 = __importDefault(require("./DisplayGroupChatMessage"));
const GroupChat = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "groupchat-component-container" }, { children: [(0, jsx_runtime_1.jsx)(GroupChatCreationForm_1.default, { user_id: user_id, loggedInUserEmail: loggedInUserEmail }), chats && Object.keys(chats).map(e => {
            ...
            }), (0, jsx_runtime_1.jsx)(DisplayGroupChatMessage_1.default, {}), (0, jsx_runtime_1.jsx)(SubmitGroupChatMessage_1.default, { senderEmail: loggedInUserEmail, receiverGroupId: receiverGroupId })] })));
};
