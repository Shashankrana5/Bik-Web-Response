            ...
            <form onSubmit={(e) => handleFormSubmit(e)}>
                <div className="flex gap-4 p-2">
                    ...
                    <div className="ticket-creation-client-name flex flex-col w-[50%]">
                        ...
                        <input placeholder="Enter client's name" className="border border-yellow-700 bg-amber-50 rounded-md placeholder:pl-2"
                    ...
                    <div className="ticket-creation-email w-[50%] flex flex-col">
                        ...
                        <input placeholder="Enter client's email" className="border border-yellow-700 bg-amber-50 rounded-md placeholder:pl-2"
                ...
                <div className="ticket-creation-subject flex flex-col p-1.5">
                    ...
                    <input placeholder="Enter Subject" className="border border-yellow-700 bg-amber-50 rounded-md w-full placeholder:pl-2"
                ...
                <div className="ticket-creation-issue">
                    ...
                    <input className="block w-full p-4 text-gray-900 border border-yellow-700 rounded-xl bg-amber-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 "
                    ...
                    <select id= "ticket-creation-form-assign-selection" className = "border border-yellow-700 bg-amber-50 rounded-md placeholder:pl-2"
                        onChange = {e => {
                            admins.forEach(admin => {
                                if(admin.email === e.target.value)
                                    setAssignedTo(admin);
                            })
                        }}
                    />
                    </div>
                <button type= "submit" id = "ticket-create-btn" className="bg-[#3091b2] text-[#fff] p-1.5 rounded-lg mt-6">Create Ticket</button>
