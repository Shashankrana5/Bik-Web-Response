...
export const DisplayMessageNavbar = (props: DisplayMessageNavbarProps) => {
    ...
    return (
        <div id="display-message-navbar" className="flex h-[10%]">
            <div id="display-message-navbar-back" onClick={handleClickBack} className="cursor-pointer h-[100%] flex-1">
                Back
            </div>
            ...
            <div id="display-message-navbar-right-invisible" className ="flex-1">
