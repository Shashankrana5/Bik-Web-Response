...
export const TicketContext = createContext<ContextType>({tickets: null, ticketsDispatch: () => null});

export const reducer = (state: TicketsType, action: ActionType): TicketsType => {
