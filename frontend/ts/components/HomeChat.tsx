...
const HomeChat: React.FC = () => {
    ...
    const [creatingPersonalChat, setCreatingPersonalChat] = useState(true)
            ...
            <div className="home-chat-wrapper flex flex-row h-full w-[100%]">
                <div className="home-chat-nav border border-black min-w-[25%] h-[100%]">
                    ...
                    <div className='chat-icon-conainer flex flex-row w-[100%] h-[15%] border border-b-orange-400'>
                        ...
                        <div className="personal-chat-icon w-[33.333333333%] h-[100%] border  border-r-orange-300 flex justify-center hover:cursor-pointer" onClick={handlePersonalChatSet}>
                        ...
                        <div className ="group-chat-icon w-[33.333333333%] h-[100%] border border-l-orange-300 flex justify-center hover:cursor-pointer" onClick={handleGroupChatSet}>
                        ...
                        <div onClick = {handleCreateChat}id="ticket-creation-division" className='"group-chat-icon w-[33.333333333%]
                ...
                <div className= "home-chat-main-body border border-blue-800 w-[75%]">
                    {creatingChat && (<div className='chat-creation-form-main'>
                            <input type = "checkbox" checked= {creatingPersonalChat} onChange={handleChange}/>

                            {creatingPersonalChat && (<div className='chat-creation-form-personal-main '>
                                
                                <label>Enter for Search user</label>
                                <input placeholder='Serach'></input>

                                <button>Create chat</button>
                            </div>)}
                            {!creatingPersonalChat && (<div className='chat-creation-form-group-main'>
                                <label>Group Name</label>
                                <input placeholder='Enter group name'></input>

                                <label>Serach Users</label>
                                <input placeholder='Enter users to add'></input>
                    ...
                    {!creatingChat && (<div>
                    <DisplayChatContent personalChat = {personalChat}/>
                    <SendMessage personalChat = {personalChat} currentChat = {currentChat} currentLoggedinUser = {currentLoggedinUser} displayChatContents = {displayChatContents} displayChatContentDispatch = {displayChatContentDispatch}/>
                    </div>)}
                </div>
            </div>
        </div>
