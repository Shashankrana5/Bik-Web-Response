      ...
      <div className="home-chat-wrapper flex flex-row h-full w-[100%]">
        <div className="home-chat-nav border border-black min-w-[25%] h-[100%]">
          <div className="chat-icon-conainer flex flex-row w-[100%] h-[15%] border border-b-orange-400">
            <div
              className="personal-chat-icon w-[33.333333333%] h-[100%] border  border-r-orange-300 flex justify-center hover:cursor-pointer"
            ...
            <div
              className="group-chat-icon w-[33.333333333%] h-[100%] border border-l-orange-300 flex justify-center hover:cursor-pointer"
            ...
            <div
              ...
              className='"group-chat-icon w-[33.333333333%]
          ...
          <ChatsNavigation
            ...
            displayChatContentDispatch={displayChatContentDispatch}
          />
        </div>

        <div className="home-chat-main-body border border-blue-800 w-[75%]">
          {creatingChat && (
            <div className="chat-creation-form-main">
              <input
                type="checkbox"
              ...
              {creatingPersonalChat && (
                <div className="chat-creation-form-personal-main ">
              ...
              {!creatingPersonalChat && (
                <div className="chat-creation-form-group-main">
